		...
		<div data-role="content" data-theme="b">
			...
			<ul data-role="listview" data-split-icon="delete" data-filter="true">
				<g:each in="${laneInstanceList}" status="i" var="laneInstance">
					<li>
						<g:link action="edit" id="${laneInstance.id}">${laneInstance}</g:link>
						<g:link action="delete" id="${laneInstance.id}" data-ajax="false"><g:message code="default.button.delete.label" default="Delete" /></g:link>
					</li>
				</g:each>
			</ul>
