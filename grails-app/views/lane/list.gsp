		...
		<div data-role="content" data-theme="b">
			...
			<ul data-role="listview" data-split-icon="gear" data-filter="true">
				<g:each in="${laneInstanceList}" status="i" var="laneInstance">
					<li>
						<g:link action="show" id="${laneInstance.id}">${laneInstance}</g:link>
						<g:link action="edit" id="${laneInstance.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					</li>
				</g:each>
			</ol>
