		...
		<div data-role="content" data-theme="b">
			...
			<ul data-role="listview" data-split-icon="delete" data-filter="true">
				<g:each in="${ownerInstanceList}" status="i" var="ownerInstance">
					<li>
						<g:link action="edit" id="${ownerInstance.id}">${ownerInstance}</g:link>
						<g:link action="delete" id="${ownerInstance.id}" data-ajax="false"><g:message code="default.button.delete.label" default="Delete" /></g:link>
					</li>
				</g:each>
			</ul>
